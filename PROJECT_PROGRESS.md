...
| Central Supplier Master | `DONE` | v1.1.0 provides one Manager/Admin submenu for data-driven types, suppliers, repeatable contacts/recipients/SOPs, products, contracts, dated rates, archive, audit, and user-wide change notifications. v1.1.1 reorganizes contact/recipient cards and makes international `+` phone/WhatsApp values formula-safe; Web App Version 16 repairs legacy formula-error cells on the existing deployment URL. |
